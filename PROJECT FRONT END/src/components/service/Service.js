    ...
    services: [
      {
        ...
        info: "Cheers to Happiness! Enjoy Free Cocktails with Every Stay!",
      },
      {
        icon: <FontAwesomeIcon icon={faHiking} />,
        title: "Endless Hiking",
        info: "Explore Nature's Majesty, Step by Step.!",
      },
      {
        icon: <FontAwesomeIcon icon={faShuttleVan} />,
        title: "Free Shuttle",
        info: "Convenient Explorations: Enjoy Free Shuttle Service to Your Adventures.!",
      },
      {
        icon: <FontAwesomeIcon icon={faBeer} />,
        title: "Unlimited Beer",
        info: "Raise a Glass: Savor Unlimited Beer, Cheers to Memorable Moments!!",
      },
    ],
  };
  return (
